= Boatswain: A utility to do node maintenance on EKS
...
* `check-ami` fetches the latest EKS AMI for a given version and displays ASGs which don't use the latest AMI
